...
package com.true_u.ifly_elevator.mediaplayer;
...
public class UniversalMediaController extends FrameLayout {
    ...
    public OnBackClickLinster mOnBackClickLinster;
...
//    private boolean mFullscreenEnabled = false;
    ...
    public interface OnBackClickLinster {
        void onBackClick(boolean flag);

        void onRightClick(boolean flag);
    }

    public void setOnBackClickLinster(OnBackClickLinster mOnBackClickLinster) {
        this.mOnBackClickLinster = mOnBackClickLinster;
    }
    ...
    private void init(Context context) {
        ...
        View viewRoot = inflater.inflate(R.layout.video_controller, this);
    ...
    private void initControllerView(View v) {
        ...
        rightIcon.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                mOnBackClickLinster.onRightClick(mIsFullScreen);
            }
        });
    }
    ...
    private View.OnClickListener mBackListener = new View.OnClickListener() {
        public void onClick(View v) {
            if (mIsFullScreen) {
                ...
                mOnBackClickLinster.onBackClick(mIsFullScreen);
            }
